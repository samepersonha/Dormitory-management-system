  ...
  <table class="imgtable">
    ...
    <c:forEach items="${users.pageData}" var="x">
      ...
      <tr height="50px">
        ...
        <td>${x.usernumber}</td>
        <td>${x.role}</td>
        <td><a href="manage/reg.jsp?userid=${x.userid }&username=${x.username}&userpwd=${x.userpwd}&usernumber=${x.usernumber}" class="tablelink">修改</a> &nbsp;&nbsp;<a href="delete?userid=${x.userid}" class="tablelink"> 删除</a></td>
      </tr>
    </c:forEach>
