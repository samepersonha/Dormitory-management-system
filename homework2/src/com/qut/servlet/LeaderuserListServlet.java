...
/**
 * Servlet implementation class LeaderuserListServlet
 */
@WebServlet("/LeaderuserListServlet")
public class LeaderuserListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LeaderuserListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("manage/LeaderuserList.jsp").forward(request, response);	
	}
